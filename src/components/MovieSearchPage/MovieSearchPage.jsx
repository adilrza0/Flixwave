...
import Skeleton from "../GalleryHorizontal/Skeleton";
      ...
      <form onSubmit={onSearch} className="search-form">
        <div className="input-group mb-3">
          ...
          <div className="input-group-append">
            <button id="search-btn" className="search-btn btn btn-light " type="submit">
              <svg
                width="1.1em"
                height="1em"
                viewBox="0 0 16 16"
...
const MovieSearchPage = ({ movieSearch }) => {
  ...
  return (
    <div>
      ...
      {searchAPI.loading && <Skeleton />}

      {searchAPI.error && (
        <div className="text-center">
          <div className="error-msg">
            {searchAPI.errorMsg ? searchAPI.errorMsg : "Something went wrong!"}
          </div>
          <button
